<div class="min-h-screen bg-white p-6">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white border border-red-500 p-8">
            <h1 class="text-2xl font-light text-gray-900 mb-6 tracking-tight">Mes amis</h1>
            ...
            <div class="mb-8 p-6 bg-gray-50 border border-gray-200">
                <h2 class="text-lg font-light text-gray-900 mb-4 tracking-tight">Ajouter un ami</h2>
                <form method="POST" action="index.php?ctl=amis&action=ajouter" class="flex gap-4">
                    <input 
                        ...
                        required
                        class="flex-1 px-4 py-2 border border-gray-300 focus:border-red-500 focus:ring-1 focus:ring-red-500 text-sm font-light"
                    >
                    <button 
                        type="submit" 
                        class="px-6 py-2 bg-red-500 text-white font-light hover:bg-red-600 transition-colors"
                    >
                        Envoyer une demande
                    </button>
                </form>
            ...
            <?php if (!empty($pendingRequests)): ?>
                <div class="mb-8">
                    <h2 class="text-lg font-light text-gray-900 mb-4 tracking-tight">Demandes reçues</h2>
                    <div class="space-y-3">
                        <?php foreach ($pendingRequests as $request): ?>
                            <div class="border border-gray-200 p-4 flex items-center justify-between">
                                <div>
                                    <h3 class="font-light text-gray-900"><?php echo htmlspecialchars($request['sender_name']); ?></h3>
                                ...
                                <div class="flex gap-2">
                                    <a 
                                        ...
                                        class="px-4 py-2 bg-green-500 text-white text-sm font-light hover:bg-green-600 transition-colors"
                                    >
                                        Accepter
                                    </a>
                                    <a 
                                        href="index.php?ctl=amis&action=refuser&id=<?php echo $request['user_id']; ?>" 
                                        class="px-4 py-2 bg-gray-500 text-white text-sm font-light hover:bg-gray-600 transition-colors"
                                    >
                                        Refuser
                                    </a>
                                </div>
            ...
            <?php if (!empty($sentRequests)): ?>
                <div class="mb-8">
                    <h2 class="text-lg font-light text-gray-900 mb-4 tracking-tight">Demandes envoyées</h2>
                    <div class="space-y-3">
                        <?php foreach ($sentRequests as $request): ?>
                            <div class="border border-gray-200 p-4 flex items-center justify-between">
                                <div>
                                    <h3 class="font-light text-gray-900"><?php echo htmlspecialchars($request['friend_name']); ?></h3>
                                ...
                                <div>
                                    <span class="px-3 py-1 text-xs bg-yellow-100 text-yellow-800 border border-yellow-300 font-light">
                                        En attente
                                    </span>
                                </div>
                            </div>
            ...
            <div>
                <h2 class="text-lg font-light text-gray-900 mb-4 tracking-tight">
                ...
                <?php else: ?>
                    <div class="space-y-3">
                        <?php foreach ($friends as $friend): ?>
                            <div class="border border-gray-200 p-4 flex items-center justify-between hover:border-red-500 transition-colors">
                                <div>
                                    <h3 class="font-light text-gray-900"><?php echo htmlspecialchars($friend['friend_name']); ?></h3>
                                ...
                                <div>
                                    <a 
                                        ...
                                        class="px-4 py-2 bg-red-500 text-white text-sm font-light hover:bg-red-600 transition-colors"
                                    >
                                        Supprimer
                                    </a>
                                </div>
